...
def data_initialization_test(data_test,rfr):
    ...
    data_test = scale_age_fare(data_test)
    return data_test
...
train_df = train_data.filter(regex='Survived|Age_.*|SibSp|Parch|Fare_.*|Cabin_.*|c1Mr|c2Mr|c3Mr|c1Mrs|c2Mrs|c3Mrs|c1Miss|c2Miss|c3Miss|c1man|c2man|c3man|c1woman|c2woman|c3woman|mother|child|mul_cabin')
...
test = data_test.filter(regex='Survived|Age_.*|SibSp|Parch|Fare_.*|Cabin_.*|c1Mr|c2Mr|c3Mr|c1Mrs|c2Mrs|c3Mrs|c1Miss|c2Miss|c3Miss|c1man|c2man|c3man|c1woman|c2woman|c3woman|mother|child|mul_cabin')
